...
export async function addSpaceUserUsingPost(
  ...
  return request<API.ResultLong_>('/api/spaceUser/add', {
    method: 'POST',
    headers: {
...
export async function deleteSpaceUserUsingPost(
  ...
  return request<API.ResultBoolean_>('/api/spaceUser/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function editSpaceUserUsingPost(
  ...
  return request<API.ResultBoolean_>('/api/spaceUser/edit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getSpaceUserUsingPost(
  ...
  return request<API.ResultSpaceUser_>('/api/spaceUser/get', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listSpaceUserUsingPost(
  ...
  return request<API.ResultListSpaceUserVO_>('/api/spaceUser/list', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
